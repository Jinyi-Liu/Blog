...
class EntryModelView(AdminAuthentication, ModelView):
	...
	column_list = [
		'title', 'status', 'author.name', 'tease', 'tag_list', 'created_timestamp',
	]
...
class TagModelView(AdminAuthentication, ModelView):
	pass
...
class LogoutModelView(AdminAuthentication, ModelView):
	@expose('/')
	def logout(self):
		logout_user()
